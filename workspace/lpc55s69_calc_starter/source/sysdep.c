...
/***************************                          ************************/
/***************************  TACHE 1.1 ETUDIANT 1   ************************/
/***************************                          ************************/


///* Color and prompt modes:
// * - CC_OUTPUT: result display
// * - CC_WARN: warning message
// * - CC_ERROR: error message
// * - CC_EDIT: standard input prompt ("> ")
// * - CC_FEDIT: function body input ("$ ")
// */
//
//// VT100 color codes
...
//#define VT_FAINT_RED     "\x1b[2;31m"
//#define VT_DEFAULT_COLOR "\x1b[0m"
//
///*** output modes ***
// * CC_OUTPUT, CC_EDIT, CC_FEDIT, CC_WARN, CC_ERROR
// */
//
//
...
//    switch (mode) {
//    case CC_OUTPUT:
//        uart_puts(USART0, VT_GREEN);  // Text in green for standard output
//        break;
//    case CC_WARN:
//        uart_puts(USART0, VT_YELLOW); // Text in yellow for warnings
//        break;
//    case CC_ERROR:
//        uart_puts(USART0, VT_RED);    // Text in red for errors
//        break;
//    case CC_EDIT:
//        uart_puts(USART0, VT_BLUE);   // Text in blue for edit mode
//        uart_puts(USART0, "> ");
//        break;
//    case CC_FEDIT:
//        uart_puts(USART0, VT_MAGENTA); // Text in magenta for function edit
//        uart_puts(USART0, "$ ");
//        break;
//    default:
//        uart_puts(USART0, VT_DEFAULT_COLOR); // Reset to default color
//        break;
//    }
//}
//
///*****
//Print a line onto the text screen, parse tabs, '\n', and handle backspace.
//Printing should be done at the cursor position. There is no need
//to clear the line at a '\n'.
//The cursor should move forward with the print, and move back with a backspace.
//*****/
...
//        } else if (*s == '\b' || *s == 127) {  // Handle backspace and delete (127 is DEL ASCII)
//            // Move cursor back, print space, and move cursor back again
//            uart_putc(USART0, '\b');  // Move cursor back
//            uart_putc(USART0, ' ');   // Print a space to "erase" character
//            uart_putc(USART0, '\b');  // Move cursor back again
//        } else {
//            uart_putc(USART0, *s);    // Print normal character
//        }
//        s++;
//    }
//    uart_puts(USART0, VT_DEFAULT_COLOR);  // Reset to default color after printing
//}
//
//
///*****
//    Wait for a keystroke and return the scancode and the ASCII code.
//    The scancode should be a code from scan_t.
//    Handles special keys including backspace.
//*****/
...
//        return '\n';
//
//    case '\x1b': { // Detecting the start of a VT100 sequence
//        char next = uart_getc(USART0);
//        if (next == '[') {
//            char seq = uart_getc(USART0);
//            switch (seq) {
//            case 'A':
//                *scan = cursor_up;
//                break;
...
//
///***** test_key
//    See if the user pressed the keyboard.
//    Return the scancode, if they did.
//*****/
//
...
//        uart_getc(USART0); // Read the character to clear the FIFO
//        return escape;     // Simulate returning the 'escape' key
//    }
//    return 0;
//}
//
///***** test_code
//    Test function for future usage.
//*****/
//int test_code(void)
//
//{
...
/***************************  END TACHE 1.1 ETUDIANT 1   ************************/
/*******************************************************************************/

/***************************                          ************************/
/***************************  TACHE 2.2 ETUDIANT 3    ************************/
/***************************                          ************************/
...
#ifndef MULTICORE_APP //rember thiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiis
