...
C_SRCS += \
../component/mma8652fc.c 

C_DEPS += \
./component/mma8652fc.d 

OBJS += \
./component/mma8652fc.o 


# Each subdirectory must supply rules for building sources it contributes
component/%.o: ../component/%.c component/subdir.mk
	@echo 'Building file: $<'
...
clean-component:
	-$(RM) ./component/mma8652fc.d ./component/mma8652fc.o

.PHONY: clean-component
